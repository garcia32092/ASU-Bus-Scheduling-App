...
public class NoteImpl implements Note, Comparable {
    ...
    public CalendarDate getDate() {
        Element day = (Element) element.getParent();
    ...
    public void setTitle(String s) {
        Attribute ta = element.getAttribute("title");
        if (ta == null) {
            element.addAttribute(new Attribute("title", s));
        }
        else {
            ta.setValue(s);
        }
    ...
    public String getId() {
        Attribute id = element.getAttribute("refid");
        if (id == null) {
            return "";
        }
        return element.getAttribute("refid").getValue();
    }
    ...
    public void setId(String s) {
        Attribute id = element.getAttribute("refid");
        if (id == null) {
            element.addAttribute(new Attribute("refid", s));
        }
    }
    ...
    public boolean isMarked() {
        return element.getAttribute("bookmark") != null;
    }
    ...
    public void setMark(boolean mark) {
        Attribute ma = element.getAttribute("bookmark");
        if (ma == null) {
            if (mark) {
                element.addAttribute(new Attribute("bookmark", "yes"));
            }
        } else if (!mark) {
            element.removeAttribute(ma);
        }
    }
